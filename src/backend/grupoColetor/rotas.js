...
const grupoColetorRouter = Router();
import bodyParser from "body-parser";
const urlencodedParser = bodyParser.urlencoded({extended:false})

//  Inserir novo grupo - Letra C no CRUD 
grupoColetorRouter.post('/novo_grupo', urlencodedParser, (req,res)=> {
...
grupoColetorRouter.get('/grupos', (req,res) => {
    var db = new sqlite3.Database(PATH); // Abre o banco
...
grupoColetorRouter.get('/atualizar_grupo', (req,res) => {
    var db = new sqlite3.Database(PATH); // Abre o banco
...
grupoColetorRouter.post('/atualizar_grupo/atualizado', (req,res) => {
    var db = new sqlite3.Database(PATH); // Abre o banco
...
grupoColetorRouter.get('/remove_grupo', urlencodedParser, (req, res) => {
	res.statusCode = 200;
...
export default grupoColetorRouter;